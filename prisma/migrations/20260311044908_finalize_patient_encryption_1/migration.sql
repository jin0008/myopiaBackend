/*
  ...
  - Added the required column `registration_number_hash` to the `patient` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "registration_number_hash" TEXT NOT NULL,
